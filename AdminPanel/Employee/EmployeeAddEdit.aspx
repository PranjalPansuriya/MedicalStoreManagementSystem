                ...
                <div class="card border-left-info shadow h-100 py-2 m-4  bg-gray-200">
                    <div class="card-body">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-8">
                                <asp:TextBox ID="txtEmployeeName" runat="server" class="form-control shadow-sm" placeholder="Enter Name" ></asp:TextBox>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-5">
                                <asp:TextBox ID="txtBirthDate" runat="server" CssClass="form-control shadow-sm form-control-user " autocomplete="off" placeholder="Select Birthdate"></asp:TextBox>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-5">
                                <asp:TextBox ID="txtMobileNo" runat="server" class="form-control shadow-sm " placeholder="Enter MobileNo"></asp:TextBox>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-8">
                                <asp:TextBox ID="txtEmail" runat="server" class="form-control shadow-sm " placeholder="Enter Email Address"></asp:TextBox>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-5">
                                <asp:TextBox ID="txtPost" runat="server" class="form-control shadow-sm " placeholder="Enter Your Post"></asp:TextBox>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-5">
                                <asp:TextBox ID="txtJoiningDate" runat="server" CssClass="form-control shadow-sm form-control-user" autocomplete="off" placeholder="Select Joining Date"></asp:TextBox>
                    ...
                    <div class="row">
                        ...
                        <div class="col-4 row">
                            <div class="col-5 text-right">
                                <asp:Button ID="btnSave" runat="server" Text="Save " CssClass="btn btn-success  shadow-lg" ValidationGroup="AddEmployee" OnClick="btnSave_Click" Visible="True"></asp:Button>
